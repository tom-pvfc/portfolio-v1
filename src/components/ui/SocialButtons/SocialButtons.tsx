    ...
    render() {
        ...
        return (
            <div className="social-buttons-container">
                <a className="share-button facebook hide-on-embed " href={state.facebookLink} target="_blank">
                    <i className="icon-facebook"></i>
                </a>
                <a className="share-button twitter hide-on-embed " href={state.twitterLink} target="_blank">
                    <i className="icon-twitter"></i>
                </a>
                <div className="share-button embed hide-on-embed " onClick={this.onEmbedClick}>
